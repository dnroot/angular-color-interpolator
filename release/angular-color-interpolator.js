...
(function() {
  (function(window, angular) {
    ...
    return angular.module('ngColorInterpolator').factory('$colorInterpolator', function() {
      var blend, splitRGB, toLongHex;
      ...
      blend = function(c1, c2, percentage) {
      ...
      return {
        interpolate: function(color, factor) {
          var blendedColor;
          if (color.match(RGB_REGEX)) {
          ...
          if (blendedColor) {
            return blend(color, blendedColor, factor);
          }
        },
        blend: blend,
        lighten: interpolate,
        darken: function(color, factor) {
          return interpolate(color, -factor);
        }
      };
    });
